...
class Window(QMainWindow): 
    ...
    def UiComponents(self):
        ...
        button1.setStyleSheet("background-color: lightgreen; color: red")
        button2.setStyleSheet("background-color: lightgreen; color: red")
        button3.setStyleSheet("background-color: lightgreen; color: red")
        button4.setStyleSheet("background-color: lightgreen; color: red")
        button5.setStyleSheet("background-color: lightgreen; color: red")
